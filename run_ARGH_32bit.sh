...
MESSAGE_LENGTH=26
DELTA=5.0
EMBEDDED_MESSAGE="11001100110011001100110011"
...
python3 argh_fix_list_vote_1010_attack_hamming_1block_bucket_prompt_log_samples_args_softanchor_multibit_topk.py \
  --model "$MODEL" \
  --dataset "$DATASET" \
